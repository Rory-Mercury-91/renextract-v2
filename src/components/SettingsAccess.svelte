          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              <div>
                ...
                <span class="text-white"> Langue de l'interface </span>
              </div>
              <!-- Theme Toggle -->
              <button
            ...
            <div class="grid grid-cols-2 gap-8">
              ...
              <div class="space-y-4">
                <div>
                  ...
                  >
                  <select id="notification-mode" class="unified-select">
      ...
      {:else if activeTab === 'theme_customizer'}
        <div class="space-y-8">
          <div>
            ...
            <p class="text-gray-400 mb-6">
              Modifiez TOUTES les couleurs de l'interface selon vos préférences
              personnelles.
            </p>
          </div>
        </div>
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <div class="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      <span class="text-sm text-gray-400"
                        >{config.colors.buttons.extract}</span
                      >
                    </div>
                  </div>
                  ...
                  <div>
                    <label
                      for="reconstruct-color"
                      class="block text-sm font-medium mb-2"
                      >Bouton Reconstruire :</label
                    >
                    <div class="flex items-center gap-3">
                      <input
                      ...
                      />
                      <span class="text-sm text-gray-400"
                        >{config.colors.buttons.reconstruct}</span
                      >
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      />
                      <span class="text-sm text-gray-400"
                        >{config.colors.buttons.verify}</span
                      >
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      />
                      <span class="text-sm text-gray-400"
                        >{config.colors.accent.primary}</span
                      >
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="flex gap-4 p-4 bg-gray-800 rounded-lg">
                    ...
                    <button
                      style="background-color: {config.colors.buttons
                        .reconstruct};"
                      class="px-4 py-2 text-white rounded hover:opacity-80 transition-opacity"
                    >
                      🔨 Reconstruire
            ...
            <div class="space-y-8">
              ...
              <div>
                ...
                <p class="text-sm text-gray-400 mb-4">
                  Spécifiez des chemins personnalisés pour vos éditeurs
                  (optionnel):
                </p>
