<script lang="ts">
  ...
  let { showAboutModal = $bindable() } = $props();
</script>
...
>
  <div
    class="shadow-xl² mx-4 w-full max-w-md rounded-2xl border border-gray-300 bg-white p-6 dark:border-gray-600 dark:bg-gray-800"
  >
